...
const Hero = () => {
  return (
    <div className='hero' id='home'>
        <img src={profile_pic} alt='profile-pic' className='hero-img'/>
        ...
        <div className="hero-action">
            ...
            <div className="hero-resume"><a href='/UsmanAli-CV.pdf' download='UsmanAli-CV.pdf' className='ahref'>My Resume</a></div>
        </div>
    </div>
  )
}
